...
LPCWSTR helpText[10]{
	L"Пример ввода данных: 10y041,Арамис,Королева Анна (без пробела перед и после запятой, с большой буквы, в названиях с числами раскладка на кирилице для набора букв)",
	L"Пример ввода данных: бн,24063 (без пробела перед запятой и после запятой, с большой буквы, в названиях с числами раскладка на кирилице для набора букв)",
